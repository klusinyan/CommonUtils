...
typedef NS_ENUM(NSUInteger, ViewPagerOption) {
    ViewPagerOptionTabOriginX,
    ViewPagerOptionTabOriginY,
...
/**
 * Reloads subview of the tabs view.
 * Invoker should do response to viewPager:contentViewForTab:atIndex to adjust tab's content view
 * Calling this method without changing any option will affect the performance.
 */
- (void)setNeedsReloadTabViews;

/**
 * Reloads controllers of the tabs view.
 * Invoker should do response to viewPager:controllerForTab:atIndex to adjust tab's controller
 * Calling this method without changing any option will affect the performance.
 */
...
/**
 * You can set navigationBarHidden to YES if the content view controller
 * is inside of super containerView
 * Default value is NO
 */
...
/**
 * The tab's content view when tab is selected.
 *
 * @param viewPager The viewPager that's subject to
